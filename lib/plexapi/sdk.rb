...
module OpenApiSDK
  ...
  class PlexAPI
    ...
    attr_accessor :server, :media, :activities, :butler, :hubs, :search, :library, :log, :plex_tv, :playlists, :security, :sessions, :updater, :video
    ...
    def init_sdks
      ...
      @plex_tv = PlexTv.new(@sdk_configuration)
