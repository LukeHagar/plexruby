...
module OpenApiSDK
  module Operations
    ...
    class GetLibrariesDirectory < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :location, T.nilable(T::Array[Operations::GetLibrariesLocation]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Location') } }
