...
module OpenApiSDK
  module Operations
    ...
    class TranscodeSession < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(audio_channels: T.nilable(Float), audio_codec: T.nilable(String), audio_decision: T.nilable(String), complete: T.nilable(T::Boolean), container: T.nilable(String), context: T.nilable(String), duration: T.nilable(Float), error: T.nilable(T::Boolean), key: T.nilable(String), max_offset_available: T.nilable(Float), min_offset_available: T.nilable(Float), progress: T.nilable(Float), protocol: T.nilable(String), size: T.nilable(Float), source_audio_codec: T.nilable(String), source_video_codec: T.nilable(String), speed: T.nilable(Float), throttled: T.nilable(T::Boolean), time_stamp: T.nilable(Float), transcode_hw_requested: T.nilable(T::Boolean), video_codec: T.nilable(String), video_decision: T.nilable(String)).void }
      def initialize(audio_channels: nil, audio_codec: nil, audio_decision: nil, complete: nil, container: nil, context: nil, duration: nil, error: nil, key: nil, max_offset_available: nil, min_offset_available: nil, progress: nil, protocol: nil, size: nil, source_audio_codec: nil, source_video_codec: nil, speed: nil, throttled: nil, time_stamp: nil, transcode_hw_requested: nil, video_codec: nil, video_decision: nil)
    ...
    class GetTranscodeSessionsMediaContainer < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(size: T.nilable(Float), transcode_session: T.nilable(T::Array[Operations::TranscodeSession])).void }
