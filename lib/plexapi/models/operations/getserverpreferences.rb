...
module OpenApiSDK
  module Operations
    ...
    class GetServerPreferencesResponse < OpenApiSDK::Utils::FieldAugmented
      ...
      # Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
      field :object, T.nilable(Operations::GetServerPreferencesResponseBody)


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, object: T.nilable(Operations::GetServerPreferencesResponseBody)).void }
