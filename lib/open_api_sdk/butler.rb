...
module OpenApiSDK
  ...
  class Butler
    ...
    sig { params(task_name: ::OpenApiSDK::Operations::TaskName).returns(Utils::FieldAugmented) }
    ...
    sig { params(task_name: ::OpenApiSDK::Operations::PathParamTaskName).returns(Utils::FieldAugmented) }
