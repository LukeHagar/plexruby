...
module OpenApiSDK
  ...
  class Hubs
    ...
    sig { params(count: T.nilable(::Float), only_transient: T.nilable(::OpenApiSDK::Operations::OnlyTransient)).returns(Utils::FieldAugmented) }
    ...
    sig { params(section_id: ::Float, count: T.nilable(::Float), only_transient: T.nilable(::OpenApiSDK::Operations::QueryParamOnlyTransient)).returns(Utils::FieldAugmented) }
