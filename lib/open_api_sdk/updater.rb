...
module OpenApiSDK
  ...
  class Updater
    ...
    sig { params(download: T.nilable(::OpenApiSDK::Operations::Download)).returns(Utils::FieldAugmented) }
    ...
    sig { params(tonight: T.nilable(::OpenApiSDK::Operations::Tonight), skip: T.nilable(::OpenApiSDK::Operations::Skip)).returns(Utils::FieldAugmented) }
