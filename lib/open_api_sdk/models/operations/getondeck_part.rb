...
module OpenApiSDK
  module Operations
    ...
    class GetOnDeckPart < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :stream, T.nilable(T::Array[::OpenApiSDK::Operations::GetOnDeckStream]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Stream') } }

      field :video_profile, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('videoProfile') } }


      sig { params(audio_profile: T.nilable(::String), container: T.nilable(::String), duration: T.nilable(::Float), file: T.nilable(::String), id: T.nilable(::Float), key: T.nilable(::String), size: T.nilable(::Float), stream: T.nilable(T::Array[::OpenApiSDK::Operations::GetOnDeckStream]), video_profile: T.nilable(::String)).void }
