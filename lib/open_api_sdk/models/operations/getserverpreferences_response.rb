...
module OpenApiSDK
  module Operations
    ...
    class GetServerPreferencesResponse < ::OpenApiSDK::Utils::FieldAugmented
      ...
      # Server Preferences
      field :two_hundred_application_json_object, T.nilable(::OpenApiSDK::Operations::GetServerPreferencesResponseBody)
      # Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
      field :four_hundred_and_one_application_json_object, T.nilable(::OpenApiSDK::Operations::GetServerPreferencesServerResponseBody)


      sig { params(content_type: ::String, raw_response: ::Faraday::Response, status_code: ::Integer, two_hundred_application_json_object: T.nilable(::OpenApiSDK::Operations::GetServerPreferencesResponseBody), four_hundred_and_one_application_json_object: T.nilable(::OpenApiSDK::Operations::GetServerPreferencesServerResponseBody)).void }
