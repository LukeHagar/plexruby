...
module OpenApiSDK
  module Operations
    ...
    class GetOnDeckMediaContainer < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :metadata, T.nilable(T::Array[::OpenApiSDK::Operations::GetOnDeckMetadata]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Metadata') } }
      ...
      sig { params(allow_sync: T.nilable(T::Boolean), identifier: T.nilable(::String), media_tag_prefix: T.nilable(::String), media_tag_version: T.nilable(::Float), metadata: T.nilable(T::Array[::OpenApiSDK::Operations::GetOnDeckMetadata]), mixed_parents: T.nilable(T::Boolean), size: T.nilable(::Float)).void }
