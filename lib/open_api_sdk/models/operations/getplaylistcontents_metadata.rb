...
module OpenApiSDK
  module Operations
    ...
    class GetPlaylistContentsMetadata < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :country, T.nilable(T::Array[::OpenApiSDK::Operations::GetPlaylistContentsCountry]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Country') } }

      field :director, T.nilable(T::Array[::OpenApiSDK::Operations::GetPlaylistContentsDirector]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Director') } }

      field :duration, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('duration') } }

      field :genre, T.nilable(T::Array[::OpenApiSDK::Operations::GetPlaylistContentsGenre]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Genre') } }
      ...
      field :media, T.nilable(T::Array[::OpenApiSDK::Operations::GetPlaylistContentsMedia]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Media') } }
      ...
      field :role, T.nilable(T::Array[::OpenApiSDK::Operations::GetPlaylistContentsRole]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Role') } }
