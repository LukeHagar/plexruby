...
module OpenApiSDK
  module Operations
    ...
    class Hub < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :metadata, T.nilable(T::Array[::OpenApiSDK::Operations::GetGlobalHubsMetadata]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Metadata') } }
      ...
      sig { params(context: T.nilable(::String), hub_identifier: T.nilable(::String), hub_key: T.nilable(::String), key: T.nilable(::String), metadata: T.nilable(T::Array[::OpenApiSDK::Operations::GetGlobalHubsMetadata]), more: T.nilable(T::Boolean), promoted: T.nilable(T::Boolean), size: T.nilable(::Integer), style: T.nilable(::String), title: T.nilable(::String), type: T.nilable(::String)).void }
