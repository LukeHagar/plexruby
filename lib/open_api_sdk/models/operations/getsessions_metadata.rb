...
module OpenApiSDK
  module Operations
    ...
    class GetSessionsMetadata < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :media, T.nilable(T::Array[::OpenApiSDK::Operations::GetSessionsMedia]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Media') } }
      ...
      field :player, T.nilable(::OpenApiSDK::Operations::Player), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Player') } }
      ...
      field :session, T.nilable(::OpenApiSDK::Operations::Session), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Session') } }
