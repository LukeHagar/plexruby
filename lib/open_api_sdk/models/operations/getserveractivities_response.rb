...
module OpenApiSDK
  module Operations
    ...
    class GetServerActivitiesResponse < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :two_hundred_application_json_object, T.nilable(::OpenApiSDK::Operations::GetServerActivitiesResponseBody)
      # Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
      field :four_hundred_and_one_application_json_object, T.nilable(::OpenApiSDK::Operations::GetServerActivitiesActivitiesResponseBody)


      sig { params(content_type: ::String, raw_response: ::Faraday::Response, status_code: ::Integer, two_hundred_application_json_object: T.nilable(::OpenApiSDK::Operations::GetServerActivitiesResponseBody), four_hundred_and_one_application_json_object: T.nilable(::OpenApiSDK::Operations::GetServerActivitiesActivitiesResponseBody)).void }
