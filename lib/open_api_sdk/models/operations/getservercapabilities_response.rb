...
module OpenApiSDK
  module Operations
    ...
    class GetServerCapabilitiesResponse < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :two_hundred_application_json_object, T.nilable(::OpenApiSDK::Operations::GetServerCapabilitiesResponseBody)
      # Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
      field :four_hundred_and_one_application_json_object, T.nilable(::OpenApiSDK::Operations::GetServerCapabilitiesServerResponseBody)
