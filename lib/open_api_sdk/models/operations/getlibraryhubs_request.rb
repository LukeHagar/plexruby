...
module OpenApiSDK
  module Operations
    ...
    class GetLibraryHubsRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :only_transient, T.nilable(::OpenApiSDK::Operations::QueryParamOnlyTransient), { 'query_param': { 'field_name': 'onlyTransient', 'style': 'form', 'explode': true } }


      sig { params(section_id: ::Float, count: T.nilable(::Float), only_transient: T.nilable(::OpenApiSDK::Operations::QueryParamOnlyTransient)).void }
