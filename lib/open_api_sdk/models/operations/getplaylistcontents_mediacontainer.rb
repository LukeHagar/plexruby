...
module OpenApiSDK
  module Operations
    ...
    class GetPlaylistContentsMediaContainer < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :metadata, T.nilable(T::Array[::OpenApiSDK::Operations::GetPlaylistContentsMetadata]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Metadata') } }
      ...
      sig { params(composite: T.nilable(::String), duration: T.nilable(::Integer), leaf_count: T.nilable(::Integer), metadata: T.nilable(T::Array[::OpenApiSDK::Operations::GetPlaylistContentsMetadata]), playlist_type: T.nilable(::String), rating_key: T.nilable(::String), size: T.nilable(::Integer), smart: T.nilable(T::Boolean), title: T.nilable(::String)).void }
