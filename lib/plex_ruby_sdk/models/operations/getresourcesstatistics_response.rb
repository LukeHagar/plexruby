...
module PlexRubySDK
  module Operations
    ...
    class GetResourcesStatisticsResponse < ::PlexRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :bad_request, T.nilable(::PlexRubySDK::Operations::GetResourcesStatisticsBadRequest)
      # Resource Statistics
      field :object, T.nilable(::PlexRubySDK::Operations::GetResourcesStatisticsResponseBody)
      # Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
      field :unauthorized, T.nilable(::PlexRubySDK::Operations::GetResourcesStatisticsUnauthorized)
