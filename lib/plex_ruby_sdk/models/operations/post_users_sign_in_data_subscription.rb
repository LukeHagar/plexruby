  ...
  module Models
    module Operations
      ...
      class PostUsersSignInDataSubscription
        ...
        field :status, T.nilable(Models::Operations::PostUsersSignInDataAuthenticationStatus), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Operations::PostUsersSignInDataAuthenticationStatus, true) } }
        ...
        sig { params(active: T.nilable(T::Boolean), features: T.nilable(T::Array[::String]), payment_service: T.nilable(::String), plan: T.nilable(::String), status: T.nilable(Models::Operations::PostUsersSignInDataAuthenticationStatus), subscribed_at: T.nilable(::String)).void }
