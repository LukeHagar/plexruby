...
module PlexRubySDK
  module Operations
    ...
    class PostUsersSignInDataSubscription < ::PlexRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :status, T.nilable(::PlexRubySDK::Operations::PostUsersSignInDataAuthenticationStatus), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(::PlexRubySDK::Operations::PostUsersSignInDataAuthenticationStatus, true) } }
