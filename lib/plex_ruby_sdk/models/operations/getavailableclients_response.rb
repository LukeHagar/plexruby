...
module PlexRubySDK
  module Operations
    ...
    class GetAvailableClientsResponse < ::PlexRubySDK::Utils::FieldAugmented
      ...
      field :bad_request, T.nilable(::PlexRubySDK::Operations::GetAvailableClientsBadRequest)
      # Available Clients
      field :object, T.nilable(::PlexRubySDK::Operations::GetAvailableClientsResponseBody)
      # Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
      field :unauthorized, T.nilable(::PlexRubySDK::Operations::GetAvailableClientsUnauthorized)
