  ...
  module Models
    module Operations
      ...
      class Services
        ...
        field :status, Models::Operations::GetTokenDetailsStatus, { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Operations::GetTokenDetailsStatus, false) } }

        field :token, ::String, { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('token') } }


        sig { params(endpoint: ::String, identifier: ::String, secret: ::String, status: Models::Operations::GetTokenDetailsStatus, token: ::String).void }
