  ...
  module Models
    module Operations
      ...
      class GetRecentlyAddedSort
        ...
        # 
        field :default_direction, Models::Operations::GetRecentlyAddedDefaultDirection, { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('defaultDirection'), 'decoder': Utils.enum_from_string(Models::Operations::GetRecentlyAddedDefaultDirection, false) } }
        ...
        # The direction of the sort. Can be either `asc` or `desc`.
        # 
        field :active_direction, T.nilable(Models::Operations::GetRecentlyAddedActiveDirection), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('activeDirection'), 'decoder': Utils.enum_from_string(Models::Operations::GetRecentlyAddedActiveDirection, true) } }
        ...
        sig { params(default_direction: Models::Operations::GetRecentlyAddedDefaultDirection, key: ::String, title: ::String, active: T.nilable(T::Boolean), active_direction: T.nilable(Models::Operations::GetRecentlyAddedActiveDirection), default: T.nilable(::String), desc_key: T.nilable(::String), first_character_key: T.nilable(::String)).void }
