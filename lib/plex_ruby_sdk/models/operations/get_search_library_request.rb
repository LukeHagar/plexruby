  ...
  module Models
    module Operations
      ...
      class GetSearchLibraryRequest
        ...
        # 
        field :type, Models::Operations::GetSearchLibraryQueryParamType, { 'query_param': { 'field_name': 'type', 'style': 'form', 'explode': true } }


        sig { params(section_key: ::Integer, type: Models::Operations::GetSearchLibraryQueryParamType).void }
