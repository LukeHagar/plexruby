  ...
  module Models
    module Operations
      ...
      class GetRecentlyAddedLibraryMediaContainer
        ...
        field :field_type, T.nilable(T::Array[Models::Operations::FieldType]), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('FieldType') } }
        ...
        field :metadata, T.nilable(T::Array[Models::Operations::GetRecentlyAddedLibraryMetadata]), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('Metadata') } }
        ...
        field :type, T.nilable(T::Array[Models::Operations::GetRecentlyAddedLibraryType]), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('Type') } }


        sig { params(allow_sync: T.nilable(T::Boolean), field_type: T.nilable(T::Array[Models::Operations::FieldType]), identifier: T.nilable(::String), media_tag_prefix: T.nilable(::String), media_tag_version: T.nilable(::Float), metadata: T.nilable(T::Array[Models::Operations::GetRecentlyAddedLibraryMetadata]), mixed_parents: T.nilable(T::Boolean), size: T.nilable(::Float), type: T.nilable(T::Array[Models::Operations::GetRecentlyAddedLibraryType])).void }
