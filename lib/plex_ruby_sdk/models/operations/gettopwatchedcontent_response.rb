...
module PlexRubySDK
  module Operations
    ...
    class GetTopWatchedContentResponse < ::PlexRubySDK::Utils::FieldAugmented
      ...
      field :bad_request, T.nilable(::PlexRubySDK::Operations::GetTopWatchedContentBadRequest)
      # The metadata of the library item.
      field :object, T.nilable(::PlexRubySDK::Operations::GetTopWatchedContentResponseBody)
      # Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
      field :unauthorized, T.nilable(::PlexRubySDK::Operations::GetTopWatchedContentUnauthorized)
