  ...
  module Models
    module Operations
      ...
      class GetRecentlyAddedLibraryMetadata
        ...
        field :country, T.nilable(T::Array[Models::Operations::GetRecentlyAddedLibraryCountry]), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('Country') } }

        field :director, T.nilable(T::Array[Models::Operations::GetRecentlyAddedLibraryDirector]), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('Director') } }

        field :duration, T.nilable(::Float), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('duration') } }

        field :genre, T.nilable(T::Array[Models::Operations::GetRecentlyAddedLibraryGenre]), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('Genre') } }
        ...
        field :media, T.nilable(T::Array[Models::Operations::GetRecentlyAddedLibraryMedia]), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('Media') } }
        ...
        field :role, T.nilable(T::Array[Models::Operations::GetRecentlyAddedLibraryRole]), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('Role') } }
        ...
        field :writer, T.nilable(T::Array[Models::Operations::GetRecentlyAddedLibraryWriter]), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('Writer') } }
