  ...
  module Models
    module Operations
      ...
      class GetMediaPostersMediaContainer
        ...
        field :metadata, T::Array[Models::Operations::GetMediaPostersMetadata], { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('Metadata') } }
        # Number of media items returned in this response.
        field :size, ::Integer, { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('size') } }


        sig { params(identifier: ::String, media_tag_prefix: ::String, media_tag_version: ::Integer, metadata: T::Array[Models::Operations::GetMediaPostersMetadata], size: ::Integer).void }
