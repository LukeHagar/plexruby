  ...
  module Models
    module Operations
      ...
      class GetRecentlyAddedLibraryRequest
        ...
        # 
        field :type, Models::Operations::QueryParamType, { 'query_param': { 'field_name': 'type', 'style': 'form', 'explode': true } }

        field :content_directory_id, T.nilable(::Integer), { 'query_param': { 'field_name': 'contentDirectoryID', 'style': 'form', 'explode': true } }
        # Adds the Meta object to the response
        # 
        field :include_meta, T.nilable(Models::Operations::QueryParamIncludeMeta), { 'query_param': { 'field_name': 'includeMeta', 'style': 'form', 'explode': true } }
