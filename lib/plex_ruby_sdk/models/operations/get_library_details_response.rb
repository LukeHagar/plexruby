...
module PlexRubySDK
  module Operations
    ...
    class GetLibraryDetailsResponse < ::PlexRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :bad_request, T.nilable(::PlexRubySDK::Operations::GetLibraryDetailsBadRequest)
      # The details of the library
      field :object, T.nilable(::PlexRubySDK::Operations::GetLibraryDetailsResponseBody)
      # Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
      field :unauthorized, T.nilable(::PlexRubySDK::Operations::GetLibraryDetailsUnauthorized)
