  ...
  module Models
    module Operations
      ...
      class Sort
        ...
        # 
        field :default_direction, Models::Operations::DefaultDirection, { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('defaultDirection'), 'decoder': Utils.enum_from_string(Models::Operations::DefaultDirection, false) } }
        ...
        # The direction of the sort. Can be either `asc` or `desc`.
        # 
        field :active_direction, T.nilable(Models::Operations::ActiveDirection), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('activeDirection'), 'decoder': Utils.enum_from_string(Models::Operations::ActiveDirection, true) } }
        ...
        sig { params(default_direction: Models::Operations::DefaultDirection, key: ::String, title: ::String, active: T.nilable(T::Boolean), active_direction: T.nilable(Models::Operations::ActiveDirection), default: T.nilable(::String), desc_key: T.nilable(::String), first_character_key: T.nilable(::String)).void }
