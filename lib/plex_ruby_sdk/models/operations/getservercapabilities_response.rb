...
module PlexRubySDK
  module Operations
    ...
    class GetServerCapabilitiesResponse < ::PlexRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :bad_request, T.nilable(::PlexRubySDK::Operations::GetServerCapabilitiesBadRequest)
      # The Server Capabilities
      field :object, T.nilable(::PlexRubySDK::Operations::GetServerCapabilitiesResponseBody)
      # Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
      field :unauthorized, T.nilable(::PlexRubySDK::Operations::GetServerCapabilitiesUnauthorized)
