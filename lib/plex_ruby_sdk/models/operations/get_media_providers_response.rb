...
module PlexRubySDK
  module Operations
    ...
    class GetMediaProvidersResponse < ::Crystalline::FieldAugmented
      ...
      field :bad_request, T.nilable(::PlexRubySDK::Operations::GetMediaProvidersBadRequest)
      # Media providers and their features
      field :object, T.nilable(::PlexRubySDK::Operations::GetMediaProvidersResponseBody)
      # Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
      field :unauthorized, T.nilable(::PlexRubySDK::Operations::GetMediaProvidersUnauthorized)
