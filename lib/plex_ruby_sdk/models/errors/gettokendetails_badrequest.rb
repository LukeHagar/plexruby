  ...
  module Models
    module Errors
      ...
      class GetTokenDetailsBadRequest
        ...
        field :errors, T.nilable(T::Array[Models::Errors::GetTokenDetailsErrors]), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('errors') } }
        # Raw HTTP response; suitable for custom response parsing
        field :raw_response, T.nilable(::Faraday::Response), { 'format_json': { 'letter_case': ::PlexRubySDK::Utils.field_name('-') } }


        sig { params(errors: T.nilable(T::Array[Models::Errors::GetTokenDetailsErrors]), raw_response: T.nilable(::Faraday::Response)).void }
