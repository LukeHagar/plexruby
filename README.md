...
* [get_pin](docs/sdks/plextv/README.md#get_pin) - Get a Pin
* [get_token](docs/sdks/plextv/README.md#get_token) - Get Access Token
...
res = s.plex_tv.get_pin(server_url="https://plex.tv/api/v2", x_plex_client_identifier="string", strong=false)
