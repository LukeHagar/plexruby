...
res = s.library.get_library_items(section_id=4510.92, type=760.66, filter="string")
...
res = s.library.get_latest_library_items(section_id=7171.54, type=8015.12, filter="string")
...
res = s.library.get_common_library_items(section_id=2710.37, type=2760.31, filter="string")
